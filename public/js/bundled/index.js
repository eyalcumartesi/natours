...
},{"@babel/polyfill":"dTCHC","./mapBox":"k6XpQ","./login":"7yHem","./updateSettings":"l3cGY"}],"dTCHC":[function(require,module,exports) {
"use strict";
...
const displayMap = (locations)=>{
    mapboxgl.accessToken = "pk.eyJ1IjoiZXlhbGN1bWFydGVzaTA5IiwiYSI6ImNsbHVteDBjOTFnMXY0b3BzYW1zbHQxOXYifQ.7gi8ZlX8N3dpfI6d8PyfjQ";
...
const updateSettings = async (data, type)=>{
    try {
        ...
        if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", `${type.toUpperCase()} Updated Successfuly`);
            window.setTimeout(()=>{
                location.reload();
            }, 1000);
        }
